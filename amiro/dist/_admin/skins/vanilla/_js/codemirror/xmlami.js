CodeMirror.defineMode("xmlami", function(config, parserConfig) {
      ...
      if (stream.eat("!")) {
        if (stream.eat("[")) {
          if (stream.match("CDATA[")) return chain(inBlock("atom", "]]>"));
            ...
            return chain(inBlock(null, 'value="'));
        }
...
CodeMirror.defineMIME("application/xml", "xmlami");
CodeMirror.defineMIME("text/html", {name: "xmlami", htmlMode: true});
