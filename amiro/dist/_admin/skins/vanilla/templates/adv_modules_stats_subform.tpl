...
<!--
    var _cms_document_form = 'advmodulesstats';
...
-->
    ...
    <form action=##script_link## method=post enctype="multipart/form-data" name="advmodulesstats" onSubmit="return CheckForm(this);">
