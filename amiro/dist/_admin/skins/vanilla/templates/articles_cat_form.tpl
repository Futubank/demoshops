...
function OnObjectChanged__categories_form(name, first_change, evt){
  ##pictures_js_script##
  return true;
}
addFormChangedHandler(OnObjectChanged__categories_form);
...
##custom_cat_form_fields##
     ##EXT_MODULES_CUSTOM_FIELDS_DATASET_ADDON##
     ##_id_page_field##
     <tr>
       <td>
%%name%%*:
