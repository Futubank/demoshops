...
<!--#set var="external_link_checkbox" value="
     <tr>
       <td colspan="2" ##use_link_disabled##>
         <label><input type="checkbox" name="use_link" ##use_link## value="1" ##use_link_checked##>
         %%use_external_link%%</label>
       </td>
     </tr>
"-->
...
function checkFilesForm(obj){
    ...
    if(obj.use_link.checked) {
        if((obj.external_link.value.indexOf("http://") != 0 && obj.external_link.value.indexOf("https://") != 0) || obj.external_link.value.length < 8) {
...
function onChangeUseLink() {
    ...
    if(typeof(document.forms.filesForm.use_link) != "undefined") {
        if(document.forms.filesForm.use_link.checked) {
            ...
            document.getElementById("file_disabled").disabled = true;
            btnCaption = '%%add_btn%%';
        } else {
            ...
            document.getElementById("file_disabled").disabled = false;
            btnCaption = '%%upload%%';
        }
...
<table border="0" width="650" cellspacing="10" cellpadding="0">
     <tr>
       <td colspan="2">
         <label><input type="checkbox" name="active" ##active## value="1">
         %%active%%</label>
       </td>
     </tr>
     <tr>
       <td colspan="2">
         <label><input type="checkbox" name="free_download" ##free_download## value="1">
         %%free_download%%</label>
       </td>
     </tr>
     <tr>
	 ...
	 <tr>
      <td colspan="2"><div id="file_disabled" style="display: inline"><label><input type=checkbox name=force_owerwrite value="1" ##upload_disabled##>&nbsp;%%force_owerwrite%%</label></div></td>
     </tr>
     <tr>
      <td colspan="2"><label><input type=checkbox name=add_to_list value="1" ##upload_disabled##>&nbsp;%%upload_to_list%%</label></td>
     </tr>
     <tr>
