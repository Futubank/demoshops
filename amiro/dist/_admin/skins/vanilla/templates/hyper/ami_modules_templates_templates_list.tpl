...
%%include_language "templates/lang/hyper/ami_modules_templates_templates_list.lng"%%

<!--#set var="modified" value="<span style="color:red; font-weight: bold;">##value##</span>"-->

<!--#set var="admin_hint" value="<i title="%%admin_hint%%">##value##</i>"-->
