...
##--     <input type="hidden" name="cid" value="##cid##"> --##
     ...
     <tr>
       <td width="80" valign="top">%%resume_answer%%:</td>
       <td valign="top">
     ...
     <tr>
        ...
        <br>
          <input type="submit" name="send" value="%%send_btn%%" class="but" onClick="this.form.action.value='answer'">

          <input type="submit" name="cancel" value="%%cancel_btn%%" class="but" onClick="this.form.action.value='cancel'">
        <br><br>
        </td>
     </tr>
     <tr>
