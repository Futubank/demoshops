...
<!--#set var="empty" value="<table width="100%" border="0" cellspacing="0" cellpadding="4">
...
##if(DISPLAY_MODULE_COL)##
    <td width="200" class="td_small_text">##module_name##</td>
##endif##
    <td>##name##</td>
...
##--    <td width="150">##sku_map##&nbsp;</td>--##
    <td align=center>##action_edit## ##action_copy## ##action_del##</td>
</tr>
"-->
...
##if(DISPLAY_MODULE_COL)##
    <td class="first_row_all" width="200">%%module%% ##sort_module_name##</td>
##endif##
    <td class="first_row_all list_name_col">%%name%% ##sort_name##</td>
    <td class="first_row_all" width="90" align=right>%%numfields%% </td>
