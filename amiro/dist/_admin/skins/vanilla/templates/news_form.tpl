...
##--  
  ...
  if (idTab=='body' && !bState){
    alert('You are not allowed to turn off this tab :-)');
    return false;
  }
--##
...
//-->
  ...
  <br>
    <form action=##script_link## method=post enctype="multipart/form-data" name="newsform" onSubmit="return CheckForm(window.document.newsform);">
...
%%date%%:
       ...
       <td>
         ...
         <a href="javascript: void(0);" onclick="return getCalendar(event, document.newsform.date);">
        ...
        <div class="tab-control" id="tab-control" onselectstart="return false;"></div>
          <div class="tabs-container">
            <div class="tab-page" id="tab-page-announce">
              <textarea class="field" style="width:100%" rows="14" name="announce" id="announce" autocomplete="off">##announce##</textarea>
              <script type="text/javascript">
