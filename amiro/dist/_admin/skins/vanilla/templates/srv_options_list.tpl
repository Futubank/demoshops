...
<!--#set var="icons_grp_apply" value="<input type=submit class=but-long value="%%apply_btn%%">"-->
...
##modules_panel##
##specblocks_panel##
<br><div align=center>##_group_actions##</div><br>
</td></tr>
</table>
"-->
...
"-->
<!--#set var="array_value_edit" value="<div id="option_edit_##name##" style="display:none;margin-top:3px;"><textarea name="option_value_##name##" class=ta cols=100 rows="##rows##" disabled>##value_edit##</textarea></div>
"-->
...
"-->
<!--#set var="string_value_edit" value="<div id="option_edit_##name##" style="display:none;margin-top:3px;"><input name="option_value_##name##" class="field field40" type=text value="##value_edit##" disabled></div>
"-->
...
"-->
<!--#set var="char_value_edit" value="<div id="option_edit_##name##" style="display:none;margin-top:3px;"><input name="option_value_##name##" class=field type=text size=##control_length## value="##value_edit##" disabled defValue="##default_value##"></div>
"-->
...
"-->
<!--#set var="text_value_edit" value="<div id="option_edit_##name##" style="display:none;margin-top:3px;"><textarea name="option_value_##name##" class=ta cols=100 rows="##rows##" disabled>##value_edit##</textarea></div>
"-->
...
<!--#set var="enum_value_edit" value="<div id="option_edit_##name##" style="display:none;margin-top:3px;"><select name="option_value_##name##" disabled>##items##</select>
</div>
"-->

<!--#set var="enum_value_edit_10010_80;enum_value_edit_10010_70" value="<div id="option_edit_##name##" style="display:none;margin-top:3px;"><select multiple name="option_value_##name##[##additional_name##][]" disabled
##IF (allow_empty==1)##
...
<!--#set var="enum_value_edit_10010_60" value="<div id="option_edit_##name##" style="display:none;margin-top:3px;"><select name="option_value_##name##[##additional_name##][]" disabled>##items##</select>
</div>
"-->
...
<!--#set var="enum_value_edit_70;enum_value_edit_80;" value="<div id="option_edit_##name##" style="display:none;margin-top:3px;">
...
<!--#set var="period_enum_value_edit" value="<div id="option_edit_##name##" style="display:none;margin-top:3px;"><input class="field field4" type=text name="option_value_##name##[num]" value="##data_value##" disabled defValue="##default_value##">&nbsp;<select name="option_value_##name##[period]" disabled style="margin-bottom:-1px;">##items##</select></div>
"-->
...
<!--#set var="array_of_value_edit" value="<table cellspacing=0 cellpadding=0 id="option_edit_##name##" style="display:none;margin-top:3px;">##items##</table>
"-->
...
<!--#set var="enum_with_value_edit" value="<div id="option_edit_##name##" style="display:none;margin-top:3px;"><select  name="option_value_##name##[enum]" disabled style="margin-bottom:-1px;" onchange="if (this.options[this.selectedIndex].getAttribute('enum')==1) {this.form.elements['option_value_##name##[input]'].style.display='none';} else {if (this.form.elements['option_value_##name##[input]'].value < 1) {this.form.elements['option_value_##name##[input]'].value = 1} this.form.elements['option_value_##name##[input]'].style.display='inline';}">##items##</select>&nbsp;<input class="field field4" type=text name="option_value_##name##[input]" value="##data_value##" style="display:##display_enter##" size="##size##" disabled defValue="##default_value##"></div>
"-->

<!--#set var="enum_with_value_edit_250;enum_with_value_edit_260" value="<div id="option_edit_##name##" valueNameForInheritance="option_value_##name##[enum]" style="display:none;margin-top:3px;"><select  name="option_value_##name##[enum]" disabled style="margin-bottom:-1px;" onchange="if (this.options[this.selectedIndex].getAttribute('enum')==1) {this.form.elements['option_value_##name##[period]'].style.display='none';this.form.elements['option_value_##name##[num]'].style.display='none';} else {if (this.form.elements['option_value_##name##[period]'].value < 1) {this.form.elements['option_value_##name##[period]'].value = 1} this.form.elements['option_value_##name##[period]'].style.display='inline';this.form.elements['option_value_##name##[num]'].style.display='inline';}">##items##</select>&nbsp;<input class="field field4" type=text name="option_value_##name##[num]" value="##sub_data_value##" disabled defValue="##default_value##">&nbsp;<select name="option_value_##name##[period]" style="display:##display_enter##" disabled>##sub_items##</select></div>
"-->
...
<!--#set var="item_with_enum_value_edit" value="<div id="option_edit_##name##" style="display:none;margin-top:3px;"><input class=field type=text name="option_value_##name##[input]" value="##data_value##" size="##size##" disabled defValue="##default_value##">&nbsp;<select  name="option_value_##name##[enum]" disabled style="margin-bottom:-1px;">##items##</select></div>
"-->
...
function stripeGroup(oRow){
    ...
    while(typeof(rows[i]) == 'object' && rows[i].tagName == 'TR' && rows[i].id.substr(0, 10) == 'group_row_'){
        if(rows[i].style.display != 'none'){
            var enableClassName = even ? 'row2' : 'row1', disableClassName = even ? 'row1' : 'row2';
            AMI.$(rows[i]).addClass(enableClassName);
            AMI.$(rows[i]).removeClass(disableClassName);
            even = !even;
        }
        i++;
    }
...
##endif##
          <form name="group_operations_form" action="##script_link##" method="post" enctype="multipart/form-data" onsubmit="return grpApplyOptions();">
