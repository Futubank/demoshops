...
<!--#set var="checkout_form" value="
    ...
    <script type="text/javascript">
            document.paymentformprint.submit();
    </script>
    ##endif##
"-->
...
<!--#set var="pay_form" value="
    ...
    ##hiddens##
    <input type="submit" name="sbmt" class="btn" value="      ##print_button_name##      " onClick="javascript:return openPrintVersion();">
    <input type="submit" name="sbmt" class="btn" value="      ##button_name##      " onClick="javascript:return onNextClick();">
    </form>

    <script type="text/javascript">
      function openPrintVersion() {
        document.paymentform.elements["##hidden_name##"].value="##print_value##";
        document.paymentform.target='_blank';
        document.paymentform.submit();
        return true;
      }

      function onNextClick() {
        document.paymentform.target='_self';
        document.paymentform.elements["##hidden_name##"].value="##process_value##";
        return true;
      }
    </script>
"-->
