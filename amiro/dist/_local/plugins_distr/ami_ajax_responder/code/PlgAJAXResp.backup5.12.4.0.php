...
* @version $ Id: PlgAJAXResp.php 54802 2010-12-10 12:10:15  Anton $
* @package   Plugin_AJAXResponder
* @subpackage   Model
* @filesource
* @size 7681 xkqwwyxiyypnzssgwlgpzlqttmzrpkwkzsqpniiitipwlqmgqniiszikztqxgqgpmqqmpnir
* @since   5.10.0
*/
?>
<?php
...
class PlgAJAXResp{
    ...
    protected function initModel(){
        ...
        if($this->oTableModel->hasField('lang')){
            $oModelList->addWhereDef("AND " . $this->oTableModel->getFieldName('lang', $prefix) . " = '" . $this->oRequest->get('locale') . "'");
        }
