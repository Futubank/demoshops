...
* @version $ Id: PlgAJAXResp.php 61323 2013-01-21 15:21:31  Anton $
* @package   Plugin_AJAXResponder
* @subpackage   Model
* @filesource
* @size 8902 xkqwuwssyuwluukpwgitxrsigtuxtlxixnrzniiitipwlqmgqniiszikztqxgqgpmqqmpnir
* @since   5.10.0
*/
?>
<?php
...
class PlgAJAXResp{
    ...
    protected function initStateAndView(){
        ...
        $this->oState = AMI::getResourceModel('plg_ajax_resp/' . $modId . '/state');
        /*
        ...
        */
        ...
        $this->oView = AMI::getResource('plg_ajax_resp/' . $modId . '/list/view');
    }
