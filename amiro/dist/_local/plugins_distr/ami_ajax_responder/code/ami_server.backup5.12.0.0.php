...
* @version $ Id: ami_server.php 54702 2010-11-19 17:32:17  Anton $
* @package   Plugin_AJAXResponder
* @filesource
* @size 11010 xkqwtlilupgtslpwisirlmwkwgwwwmmxpiquqilwiyzkunspwqlmpzwiplkqplxxpymypnir
*/
?>
<?php
...
$aModulesSettings = array(
    'articles' => array(
        ...
        'resources' => array(
            ...
            // Plugin controller
            'plg_ajax_resp/controller'                 => 'PlgAJAXResp'
        )
    ),
    'blog' => array(
        'classes' => array(
    ...
    'search_history' => array(
        ...
        'resources' => array(
            ...
            'plg_ajax_resp/controller'                 => 'PlgAJAXResp_SearchHistory'
        )
    )
);
...
$oPluginController = AMI::getResource('plg_ajax_resp/controller', array($oRequest, $aAllowedModules));

/**
 * @exitpoint
 */
$oResponse->write($oPluginController->getResponse());
