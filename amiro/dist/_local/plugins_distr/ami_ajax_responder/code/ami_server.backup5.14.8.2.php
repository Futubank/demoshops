...
* @version $ Id: ami_server.php 61317 2013-01-21 12:56:12  Artem $
* @package   Plugin_AJAXResponder
* @filesource
* @size 11349 xkqwginmkqskmqyxiiwqgytknsltwuznkxppqilwiyzkunspwqlmpzwiplkqplxxpymypnir
*/
?>
<?php
...
if($oDeclarator->isRegistered($moduleName) && !isset($aModulesSettings[$moduleName])){
