...
<!--#set var="body;body(module=articles);body(module=blog);body(module=eshop_item);body(module=files);body(module=kb_item);body(module=news);body(module=photoalbum);body(module=portfolio_item);body(module=stickers)" value="
