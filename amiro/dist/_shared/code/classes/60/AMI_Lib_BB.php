 ...
 * @version    $Id$ 
 * @since      x.x.x 
 * @size       12202 xkqwixzsikguslkzyixkrlprzugilzqimiknrmlrztyumzrpupiugqksgkltxqkiznwzpnir
 */
?><?php
...
class AMI_Lib_BB{
     ...
     * @return string
     */
    public static function toHTML($content, $isHTMLEncoded = true, $useNoIndex = false, array $aURLParams = array()){
        // Get smile paths
        $smilesFolder = 'base';
     ...
     * @return string
     */
    public static function _getLinkContent($url, $content, $useNoIndex, array $aURLParams){
     ...
     * @return string
     */
    public static function _getCodeContent($content){
        $content = self::_pregStripSlashes($content);
