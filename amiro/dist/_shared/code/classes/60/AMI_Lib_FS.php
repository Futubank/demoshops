 ...
 * @version    $Id$ 
 * @since      x.x.x 
 * @size       9818 xkqwwgksqkwnntutmwglxtssquptprksqztwmuknxtxmpmmiiixzpuqrlykluxnupkuzpnir
 */
?><?php
...
class AMI_Lib_FS{
     ...
     * @since  7.0.0
     */
    public static function sanitizeFileName($name, $re = '~[^a-zA-Z0-9\-_\. ]~'){
     ...
     * @since  7.0.0
     */
    public static function makeDirectory($path, $mode = 0777, $recursive = TRUE, $context = NULL){
        $result =
            is_resource($context)
