 ...
 * @version    $Id$ 
 * @since      x.x.x 
 * @size       5022 xkqwygqksgmsqmrztygnxkzwkpmpwxgstmszwpmtxgkizlmigslytwpxkgtpzixlwqyppnir
 */
?><?php
...
class AMI_Lib_Image{
     ...
     * @return void
     */
    public static function saveImagesIndexFile($dirPath, $indexFile, $modTime){
     ...
     * @return array
     */
    public static function getDirOnlyOneImageParameters($dirPath, $imageFile){
     ...
     * @see    getImageSize()
     */
    public static function imageGetSize($path){
        $imgDir = dirname($path);
