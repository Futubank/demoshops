 ...
 * @version    $Id$ 
 * @since      5.14.8 
 * @size       27544 xkqwzuuituiyizuntgykigiltwyptpngsrxkuutysnytnuywrtxiuxtwtriissgitusmpnir
 */
?><?php
...
class AMI_ModCommonViewFrn extends AMI_View{
    ...
    public function getPagination(array $aParams, AMI_ModTableList $oList){
        ...
        foreach($aPagination as $aItem){
            ...
            if(in_array($aItem['type'], array('prev', 'next'))) {
                AMI_Registry::set('page/links/' . $aItem['type'], $cLinkHtmlReady);
            }
        }
