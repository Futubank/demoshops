 ...
 * @version    $Id$ 
 * @since      5.10.0 
 * @size       51525 xkqwtpqgyywtywltstwuryxyxltksrgrpzxxqrsruurilqmlpimyysiisklxgprnmxsipnir
 */
?><?php
...
abstract class AMI_ModTable implements AMI_iModTable{
    ...
    public function filterFields(array $aFields){
        $aFields = array_filter(
            $aFields,
            array($this, 'cbFilterInnerFields')
        );
        $aAlaiableFields = array_filter(
            $this->getAvailableFields(TRUE),
            array($this, 'cbFilterInnerFields')
        );

        return array_intersect($aFields, $aAlaiableFields);
    }
...
*/
    ...
    /**
     * Enables HTML meta fields.
     *
     * @return AMI_ModTable
     * @amidev
     */
    public function enableHTMLFields(){
        if($this->aSavedHTMLFields){
            $this->aHTMLFields = $this->aSavedHTMLFields;
        }
     ...
     * @amidev
     */
    public function disableHTMLFields(){
        if(!$this->aSavedHTMLFields){
            $this->aSavedHTMLFields = $this->aHTMLFields;
        }
     ...
     * @amidev Temporary
     */
    protected function cbFilterInnerFields($value){
