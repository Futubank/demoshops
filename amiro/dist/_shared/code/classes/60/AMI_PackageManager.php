 ...
 * @package    Core 
 * @version    $Id$ 
 * @size       54850 xkqwwzrkpqxslzqzwnngugqzxwrxinlsyswtwguukwwgsgqiulmyigsgixpkktrpklgipnir
 */
?><?php
...
final class AMI_PackageManager{
    ...
    /**
     * XML last content data for concat
     *
     * @var string
     */
    ...
    */
    ...
    protected function onTagContent($oParser, $content){
        ...
        if(isset($this->aXMLRules[$tag]['callbackOnContent'])){
            call_user_func($this->aXMLRules[$tag]['callbackOnContent'], $tag, $this->lastContent);
        }
    }
