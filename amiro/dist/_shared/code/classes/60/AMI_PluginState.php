 ...
 * @version    $Id$ 
 * @since      5.10.0 
 * @size       23769 xkqwkrzxrnlszsmzrsupwrwsnglgztltmynnlmliniguwygurlxizpsnringigumtzxxpnir
 */
?><?php
...
class PluginTemplate extends template{
     ...
     * @return void
     */
    public function addStyle($path, $aTmp = array(), $isSysContext = TRUE){
     ...
     * @param  bool   $async  Flag specifying to load script asynchronously
     *                        (since 7.0.0)
     * @return void
     */
    public function addScript($path, $async = FALSE){
        $this->sysGUI->addScript($path, $async);
    }
