 ...
 * @version    $Id$ 
 * @since      5.10.0 
 * @size       47886 xkqwlimxrngylriuxtiqxutgwiqtxyilpytynntqtxntkzkgkgurlyggzsxggpmysxkkpnir
 */
?><?php
...
final class AMI_Service{
    ...
    */
    ...
    public static function log($message, $path = '', $maxLogSize = self::DEFAULT_MAX_LOG_SIZE){
        if(self::$customLogSize && self::DEFAULT_MAX_LOG_SIZE === $maxLogSize){
            $maxLogSize = (int)self::$customLogSize;
        }
