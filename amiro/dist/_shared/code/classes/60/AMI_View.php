 ...
 * @version    0.8 alpha 
 * @since      5.10.0 
 * @size       13663 xkqwixqnmtwiklnizlkzmqztuinllripmqstzllwtnlggixrwpxxgiguwmmynlwmsgzypnir
 */
?><?php
            ...
            if($name){
                if($this instanceof AMI_ExtView){
                    ...
                    if($this->tplFileName === ''){
                        $this->tplFileName =
                            (
                                $isPlugin || AMI_Registry::get('side') != 'adm'
                                    ? AMI_iTemplate::TPL_MOD_PATH
                                    : AMI_iTemplate::LOCAL_TPL_MOD_PATH
                            ) . '/' . $name . '.tpl';
                    }
                    ...
                    if($this->localeFileName === ''){
                        $this->localeFileName =
                            (
                                $isPlugin || AMI_Registry::get('side') != 'adm'
                                    ? AMI_iTemplate::LNG_MOD_PATH
                                    : AMI_iTemplate::LOCAL_LNG_MOD_PATH
                            ) . '/' . $name . '.lng';
                    }
                }
            }
