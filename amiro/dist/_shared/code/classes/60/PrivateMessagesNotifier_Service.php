 ...
 * @version    $Id$ 
 * @since      x.x.x 
 * @size       1876 xkqwgrnuzgqyuqpktzmglirustqzlsinqrnkkiwmgltuupuugytxzwznkmqwuqumluimpnir
 */
?><?php
 ...
 * @amidev     Temporary
 */
class PrivateMessagesNotifier_Service extends AMI_Module_Service{
    /**
     * Dispatches messages notifier action.
     *
     * @return void
     */
