 ...
 * @version    $Id$ 
 * @since      x.x.x 
 * @size       7166 xkqwliyixxigyxpkgspilwpqwgwusyulymrxwxmttgtitgwsznknzlyxlkwlnwsmiwpipnir
 */
?><?php
 ...
 * @amidev     Temporary
 */
class PrivateMessages_Service extends AMI_Module_Service{
    /**
    ...
    public function outLocalSitesMessages(){
        ...
        if($errParams || !$bBroadcastAllowed){
            ...
            // $this->send('', 503);
            header((getenv('SERVER_PROTOCOL') ? getenv('SERVER_PROTOCOL') : 'HTTP/1.1') . ' 503 Service Temporarily Unavailable');
