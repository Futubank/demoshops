 ...
 * @version    $Id$ 
 * @since      x.x.x 
 * @size       13081 xkqwxmugwixlmkttlilmrrumtqpwtryukyluuxigplxspsyuxxqyrmqixglmumrkrltnpnir
 */
?><?php
...
class TxRollback_Service extends AMI_Module_Service{
    ...
    public function dispatchAction(AMI_Request $oRequest, AMI_Response $oResponse){
        ...
        */
        ...
        if($txRollbackId){
            ...
            $this->displayInfo($aRollback, $canRollback);
        }
     ...
     * @param  bool  $canRollback  Flag specifying ability to rollback
     * @return void
     */
    protected function displayInfo(array $aRollback, $canRollback){
        $rows = '';
    ...
    protected function wipeAllBackupData(){
        ...
        foreach(
            array(
                ...
                AMI_Registry::get('path/root') . '_local/modules/declaration' => '_*.php',
