 ...
 * @package    Config_AmiCatalog_Digitals 
 * @version    $Id$ 
 * @since      x.x.x 
 * @size       4042 xkqwuirspzpqlmulrxzzugmztsqwkkslulpzwgzxtwszutlgyplzqpprpxlsmylnkwyzpnir
 */
?><?php
...
/**
 * AmiCatalog/Digitals configuration metadata.
 *
 * @package    Config_AmiCatalog_Digitals
 * @subpackage Model
 * @since      x.x.x
 * @amidev     Temporary
 */
class AmiCatalog_Digitals_Meta extends AMI_HyperConfig_Meta{
    /**
     * Version
     *
     * @var string
