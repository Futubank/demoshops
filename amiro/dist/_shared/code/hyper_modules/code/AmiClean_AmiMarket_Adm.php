 ...
 * @version    $Id$ 
 * @since      x.x.x 
 * @size       13953 xkqwrxtwlqsksumssguyinxpsirrmgzyzprzkmiruizprqgiluiutqgpnpzsrqnlxknzpnir
 */
?><?php
...
class AmiClean_AmiMarket_HtmlViewAdm extends Hyper_AmiClean_ComponentViewAdm{
    ...
    public function get(){
        ...
        if(mb_strlen($link) > 0 && strpos($link, '/') !== 0) {
            $link = '/' . $link;
        }
        $aScope['address'] = '//www.amiro.ru/market' . $link . '?lay_id=97';
