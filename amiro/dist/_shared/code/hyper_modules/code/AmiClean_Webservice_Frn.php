 ...
 * @size       13203 xkqwwszyimuqznuwryltrxtxmgrwlkkttgryxlzsnzkmmkzypxssmlrztsxnkputixzppnir
 */
?><?php
...
class AmiClean_Webservice_ListFrn extends Hyper_AmiClean_ListAdm{
    ...
    protected function initModel(){
        ...
        $aUnsupportedExtensions = array('ext_twist_prevention', 'ext_rss', 'ce_page_break', 'adv', 'reindex');
        foreach($aUnsupportedExtensions as $unext){
            if(in_array($unext, $aExtOption)){
                unset($aExtOption[array_search($unext, $aExtOption)]);
            }
        }
