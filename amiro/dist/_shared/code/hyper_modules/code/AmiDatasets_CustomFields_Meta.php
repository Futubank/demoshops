 ...
 * @version    $Id$ 
 * @since      x.x.x 
 * @size       4083 xkqwtpsinirrsrkzmguxqplktzkmxwngxwuyswguliyrxwzuplyuwsyygpwxqnrlwuyppnir
 */
?><?php
...
/**
 * AmiDatasets/CustomFields configuration metadata.
 *
 * @package    Config_AmiDatasets_CustomFields
 * @subpackage Model
 * @since      x.x.x
 * @amidev     Temporary
 */
class AmiDatasets_CustomFields_Meta extends AMI_HyperConfig_Meta{
    /**
     * Version
     *
     * @var string
          ...
          'specblock' => array(
            ...
            'locales' => array(
              'en' => array(
                ...
                'caption' => 'CustomFields announce',
              ),
              'ru' => array(
                'name' => 'Название спецблока для менеджера сайта',
                'caption' => 'Анонс CustomFields',
              ),
            ),
          ),
        ),
