 ...
 * @version    $Id$ 
 * @since      x.x.x 
 * @size       4013 xkqwxtpuqnsmxtqsxtizlpniwuwssnswsqpzlwrypgqmzumqrytrqwsiuxgrkmqlgqwlpnir
 */
?><?php
...
/**
 * AmiEshopCoupons/Coupons configuration metadata.
 *
 * @package Config_AmiEshopCoupons_Coupons
 * @since   x.x.x
 * @amidev  Temporary
 */
class AmiEshopCoupons_Coupons_Meta extends AMI_HyperConfig_Meta{
    /**
     * Version
     *
     * @var string
          ...
          'specblock' => array(
            ...
            'locales' => array(
              'en' => array(
                ...
                'caption' => 'Coupons announce',
              ),
              'ru' => array(
                'name' => 'Название спецблока для менеджера сайта',
                'caption' => 'Анонс Coupons',
              ),
            ),
          ),
        ),
