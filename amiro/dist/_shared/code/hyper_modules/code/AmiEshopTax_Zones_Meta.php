 ...
 * @version    $Id$ 
 * @since      x.x.x 
 * @size       3999 xkqwnsnlmlwkuzqwimlpglunikuqmxpnizytxkltpiginrzizwurgupptuqquxrlywqtpnir
 */
?><?php
...
/**
 * AmiEshopTax/Zones configuration metadata.
 *
 * @package    Config_AmiEshopTax_Zones
 * @subpackage Model
 * @since      x.x.x
 * @amidev     Temporary
 */
class AmiEshopTax_Zones_Meta extends AMI_HyperConfig_Meta{
    /**
     * Version
     *
     * @var string
