 ...
 * @version    $Id$ 
 * @since      x.x.x 
 * @size       17230 xkqwskywxgigkippgpirnynyzgtzkznxipgpmzguintgittzrplslsqrxggizmuqpxntpnir
 */
?><?php
...
class AmiExt_Antispam_Frn extends Hyper_AmiExt{
    ...
    public function handlePreInit($name, array $aEvent, $handlerModId, $srcModId){
        ...
        if($this->aState['useJS'] || $this->aState['showCaptcha']){
            ...
            AMI_Event::addHandler('v5_internal_init_form_spam_protection', array($oView, 'handleGetCode'), $modId);
