 ...
 * @version    $Id$ 
 * @since      x.x.x 
 * @size       9231 xkqwswsskrimpnwtzrgzxlwgplwllulnqwmtqnzkutinmwixuttriqrmnmmyxrrwszqypnir
 */
?><?php
    ...
    protected function processFieldData($field, array $aData){
        if($field == 'show_all'){
            if($aData['value']){
                ...
                $aData['forceSQL'] = " AND `ip` NOT IN ('92.125.152.98', '92.125.152.101', '89.189.185.215', '37.194.252.244') ";
            }
        }
        return $aData;
    }
