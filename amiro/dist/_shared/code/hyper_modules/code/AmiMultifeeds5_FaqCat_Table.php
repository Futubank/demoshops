 ...
 * @version    $Id$ 
 * @since      x.x.x 
 * @size       2745 xkqwnsqgzxggtwxkzzwusunlkpxzupgzusgqtzzpiizmtkspnnnyzntwpgrmisxzwqglpnir
 */
?><?php
...
/**
 * AmiMultifeeds5/FAQ configuration category table model.
 *
 * @package    Config_AmiMultifeeds5_FAQ
 * @subpackage Model
 ...
 * @amidev
 */
class AmiMultifeeds5_FaqCat_Table extends Hyper_AmiMultifeeds5_Cat_Table{
    /**
 ...
 * @amidev
 */
class AmiMultifeeds5_FaqCat_TableItem extends Hyper_AmiMultifeeds5_Cat_TableItem{
    /**
 ...
 * @amidev
 */
class AmiMultifeeds5_FaqCat_TableList extends Hyper_AmiMultifeeds5_Cat_TableList{
}
