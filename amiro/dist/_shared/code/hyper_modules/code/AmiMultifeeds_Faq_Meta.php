 ...
 * @version    $Id$ 
 * @since      x.x.x 
 * @size       6740 xkqwtmpwimgnupsgsyptipzgurxwrsiyikgptzqwuniwspwqsmppultsurlxskrwyspppnir
 */
?><?php
...
/**
 * AmiMultifeeds/FAQ configuration metadata.
 *
 * @package    Config_AmiMultifeeds_FAQ
 * @subpackage Model
 * @since      x.x.x
 * @amidev     Temporary
 */
class AmiMultifeeds_Faq_Meta extends AMI_HyperConfig_Meta{
    /**
     * Version
     *
     * @var string
