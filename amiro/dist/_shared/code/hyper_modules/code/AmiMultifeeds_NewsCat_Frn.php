 ...
 * @version    $Id$ 
 * @since      6.0.2 
 * @size       2825 xkqwntnysqpmzstsmwgugklqsizulpkytlqqmmmsxqyznwmnkmrpzsgrqumuknunitqspnir
 */
?><?php
...
/**
 * AmiMultifeeds/News configuration category action controller.
 *
 * @package    Config_AmiMultifeeds_News
 ...
 * @since      6.0.2
 */
class AmiMultifeeds_NewsCat_Frn extends Hyper_AmiMultifeeds_Cat_Frn{
}
...
/**
 * AmiMultifeeds/News configuration category form component action controller.
 *
 * @package    Config_AmiMultifeeds_News
 * @subpackage Controller
 ...
 * @since      6.0.2
 */
class AmiMultifeeds_NewsCat_FormFrn extends Hyper_AmiMultifeeds_Cat_FormFrn{
    /**
     * Initialization.
     *
 ...
 * @since      6.0.2
 */
class AmiMultifeeds_NewsCat_FormViewFrn extends Hyper_AmiMultifeeds_Cat_FormViewFrn{
}

/**
 * AmiMultifeeds/News configuration category list component controller.
 *
 * @package    Config_AmiMultifeeds_News
 * @subpackage Controller
 ...
 * @since      7.0.0
 */
class AmiMultifeeds_NewsCat_ListFrn extends Hyper_AmiMultifeeds_ListFrn{
}

/**
 * AmiMultifeeds/News configuration category list component view.
 *
 * @package    Config_AmiMultifeeds_News
 * @subpackage View
 ...
 * @since      7.0.0
 */
class AmiMultifeeds_NewsCat_ListViewFrn extends Hyper_AmiMultifeeds_CatListViewFrn{
}
