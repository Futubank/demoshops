 ...
 * @version    $Id$ 
 * @since      6.0.2 
 * @size       2724 xkqwwwmknnulwgsrnnwuluqyyisquuzklpxyrlkwrgtluuxmlyqqxzqqmstmtnsistqspnir
 */
?><?php
...
/**
 * AmiMultifeeds/News configuration category table model.
 *
 * @package    Config_AmiMultifeeds_News
 * @subpackage Model
 ...
 * @since      6.0.2
 */
class AmiMultifeeds_NewsCat_Table extends Hyper_AmiMultifeeds_Cat_Table{
    /**
...
/**
 * AmiMultifeeds/News configuration category table item model.
 *
 * @package    Config_AmiMultifeeds_News
 * @subpackage Model
 ...
 * @since      6.0.2
 */
class AmiMultifeeds_NewsCat_TableItem extends Hyper_AmiMultifeeds_Cat_TableItem{
    /**
...
/**
 * AmiMultifeeds/News configuration category table list model.
 *
 * @package    Config_AmiMultifeeds_News
 * @subpackage Model
 ...
 * @since      6.0.2
 */
class AmiMultifeeds_NewsCat_TableList extends Hyper_AmiMultifeeds_Cat_TableList{
}
