 ...
 * @version    $Id$ 
 * @since      6.0.2 
 * @size       3705 xkqwwkpmtuskgyppzprrgxrtipizustxuqgrkmgxilyyirtxsggllllquytitluqypyspnir
 */
?><?php
...
/**
 * AmiMultifeeds/News configuration table model.
 *
 ...
 * @since      6.0.2
 */
class AmiMultifeeds_News_Table extends Hyper_AmiMultifeeds_Table{
    /**
...
/**
 * AmiMultifeeds/News configuration table item model.
 *
 * @package    Config_AmiMultifeeds_News
 * @subpackage Model
 ...
 * @since      6.0.2
 */
class AmiMultifeeds_News_TableItem extends Hyper_AmiMultifeeds_TableItem{
    /**
...
/**
 * AmiMultifeeds/News configuration table list model.
 *
 * @package    Config_AmiMultifeeds_News
 * @subpackage Model
 ...
 * @since      6.0.2
 */
class AmiMultifeeds_News_TableList extends Hyper_AmiMultifeeds_TableList{
}
