 ...
 * @version    $Id$ 
 * @since      x.x.x 
 * @size       4055 xkqwlqqgtqimiutkngikmnsispxwlgniuiskxymuutmsskkmgpzzzwsznmwzrrnsmwinpnir
 */
?><?php
...
/**
 * AmiPageManager/Layouts configuration metadata.
 *
 * @package    Config_AmiPageManager_Layouts
 * @subpackage Model
 * @since      x.x.x
 * @amidev     Temporary
 */
class AmiPageManager_Layouts_Meta extends AMI_HyperConfig_Meta{
    /**
     * Version
     *
     * @var string
          ...
          'specblock' => array(
            ...
            'locales' => array(
              'en' => array(
                ...
                'caption' => 'Layouts announce',
              ),
              'ru' => array(
                'name' => 'Название спецблока для менеджера сайта',
                'caption' => 'Анонс Layouts',
              ),
            ),
          ),
        ),
