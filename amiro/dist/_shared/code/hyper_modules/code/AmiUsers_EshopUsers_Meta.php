 ...
 * @version    $Id$ 
 * @since      x.x.x 
 * @size       4056 xkqwnwsmsukzzltkttisrltyqzpqgtiugtkygwttrruswkikgmymsinluryqupkngqlupnir
 */
?><?php
...
/**
 * AmiUsers/EshopUsers configuration metadata.
 *
 * @package    Config_AmiUsers_EshopUsers
 * @subpackage Model
 * @since      x.x.x
 * @amidev     Temporary
 */
class AmiUsers_EshopUsers_Meta extends AMI_HyperConfig_Meta{
    /**
     * Version
     *
     * @var string
          ...
          'specblock' => array(
            ...
            'locales' => array(
              'en' => array(
                ...
                'caption' => 'EshopUsers announce',
              ),
              'ru' => array(
                'name' => 'Название спецблока для менеджера сайта',
                'caption' => 'Анонс EshopUsers',
              ),
            ),
          ),
        ),
