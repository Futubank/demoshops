 ...
 * @version    $Id$ 
 * @since      x.x.x 
 * @size       12672 xkqwklnlnuyqpykwinpmuprntwktzklgqntrrktlgrunzggnpnzirugwugxuryixlxpspnir
 */
?><?php
...
class AmiUsers_Users_FilterModelAdm extends Hyper_AmiUsers_FilterModelAdm{
    ...
    public function __construct(){
        ...
        if(!AMI::issetAndTrueOption('core', 'su') && !empty($GLOBALS['AMI_ALLOW_EFNSU'])){
            $this->addViewField(
                array(
                    'name'          => 'edit_front_allowed',
                    'type'          => 'checkbox',
                    'flt_default'   => '0',
                    'flt_condition' => '=',
                    'flt_column'    => 'edit_front_allowed',
                    'act_as_int'    => TRUE,
                    'disable_empty' => TRUE
                )
            );
