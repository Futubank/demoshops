...
Шаблоны модуля подключаются и наследуются в следующем порядке:
  ...
  2. Шаблон конфигурации "Новости" содержит и переопределяет только элементы оформления, которые должны
...
Templates are including and are inherited in the following order:
  ...
  2. Template of configuration "News" contains and overrides only design elements that must
...
##--
Подключаемый шаблон кофигурации "Новости" "ami_multifeeds_news.tpl"

Included template of configuration "News" "ami_multifeeds_news.tpl"
--##
%%include_template "templates/hyper/ami_multifeeds_news.tpl"%%
