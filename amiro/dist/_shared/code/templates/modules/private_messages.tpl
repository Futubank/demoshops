...
%%include_language "templates/lang/modules/private_messages_client.lng"%%
...
<div id="module_##mod_id##" class="modPageArea">
	...
	<div id="compose_message_div"><input type="button" class="btn" value="%%compose_message%%" onclick="amiPMCompose();" id="compose_message"></div>
    <a style="margin-bottom: 3px;" id="read_all_messages" class="btn" onclick="markAllAsRead();">%%mark_all_as_read%%</a>
	<div id="paga">
