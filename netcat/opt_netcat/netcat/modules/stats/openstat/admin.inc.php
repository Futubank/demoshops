...
function show_reports($counter_id) {
    ...
    if ($counters[$counter_id]->User_Counter_Code) {
        echo "<script type='text/javascript' src='" . nc_add_revision_to_url($nc_core->SUB_FOLDER . $nc_core->HTTP_ROOT_PATH . 'modules/stats/openstat/reports.js') . "'></script>\n";
        ...
        echo "<script type='text/javascript' src='" . nc_add_revision_to_url($nc_core->SUB_FOLDER . $nc_core->HTTP_ROOT_PATH . 'modules/stats/openstat/ajax_reports.js') . "'></script>\n";
